            ...
            <div className="relative pb-[124px]">
                <Container>
                    ...
                    <div  className="lg:pt-[100px] pt-[30px] "  >
                        ...
                        <div  data-aos="fade-up" className="flex items-center lg:w-[31%] w-[62%]  bg-opacity-20 text-[#ffffff] text-sm pl-3 pr-3 py-1 border-[1px] border-[#ffffff46] bg-[#ffffff1c] rounded-full ">
                            <span  className="w-[5px] h-[5px] bg-blue-400 rounded-full mr-2 " ></span>
                            Welcome to my portfolio
                        </div>
                        </div>
                        <div className="">
                            <h1 data-aos="fade-up" className='lg:text-[64px] text-[40px] lg:text-start text-center font-popins font-bold text-[#fff] pt-[20px]  '>Full Stack Developer</h1>
                            <p data-aos="fade-up" className='lg:text-[24px] text-[18px] lg:text-start text-center font-popins text-[rgba(255,255,255,0.63)] py-[20px] '>Turning ideas into reality</p>
                            <p data-aos="fade-up" className='lg:text-[20px] text-[16px] lg:text-start text-center font-popins text-[rgba(255,255,255,0.63)] '>Building modern web applications with passion</p>


                            <div data-aos="fade-up" className="flex lg:justify-start justify-center pt-[40px] gap-x-6 ">
                            ...
                            <div data-aos="fade-up" className="flex items-center lg:justify-start justify-center lg:gap-x-20 gap-x-6 pt-[50px]   ">
                        ...
                        <div data-aos="fade-up"  className="relative mx-auto lg:mx-0   ">
