        ...
        <div>
            <Container>
                ...
                <div className="lg:flex justify-between">
                    <div className='w-1/4' >
                        <h3 className='text-[28px] font-popins font-semibold text-blue-600'>Portfolio</h3>
                    </div>
                    ...
                    <div className='w-1/4 lg:mt-0 mt-[10px]' >
                        <h5 className='text-[16px] text-[#000] font-popins font-medium lg:w-0  w-[120px] uppercase'>Get In Touch</h5>
                        <div className=" h-[140px] lg:w-[370px] w-[300px] bg-[#F5F8FF] rounded-2xl lg:mt-[60px] mt-[10px] lg:pt-[30px] pt-[20px] ">
